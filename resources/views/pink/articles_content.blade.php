            ...
            <div class="sticky hentry hentry-post blog-big group">
                ...
                <div class="thumbnail">
                    ...
                    <div class="image-wrap">
                        <img src="{{ asset(config('settings.theme')) }}/images/articles/{{ $article->img ? $article->img->max : '' }}" alt="001" title="001"/>
                    </div>
                    <p class="date">
                ...
                <div class="the-content group">
                    ...
                    <p><a href="{{ route('articles.show',['alias' => $article->alias]) }}"
                          class="btn   btn-beetle-bus-goes-jamba-juice-4 btn-more-link">> {{ Lang::get('ru.read_more') }}</a></p>
                </div>
                <div class="clear"></div>
            </div>
        @endforeach
